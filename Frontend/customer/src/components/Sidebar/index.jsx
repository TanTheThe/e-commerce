...
const Sidebar = () => {
    ...
    return (
        <aside className="sidebar py-5">
            <div className="box">
                <h3 className="w-full text-[16px] font-[600] flex items-center pr-5">Shop by Category
            ...
            <div className="box mt-5">
                <h3 className="w-full text-[16px] font-[600] flex items-center pr-5">Availability
                    <Button className="!w-[30px] !h-[30px] !min-w-[30px] !rounded-full !ml-auto !text-[#000]" onClick={() => setIsOpenAvailableFilter(!isOpenAvailableFilter)}>
                        {
            ...
            <div className="box mt-5">
                <h3 className="w-full text-[16px] font-[600] flex items-center pr-5">Size
