...
const columns = [
    ...
    { id: 'cateName', label: 'CATEGORY NAME', minWidth: 250 },
    { id: 'subCateName', label: 'SUB CATEGORY NAME', minWidth: 400 },
                                    ...
                                    <div className="flex items-center gap-4 w-[80px]">
                                        <div className="img w-full rounded-md overflow-hidden group">
                                            <a href="/product/45745" data-discover="true">
                                                <img className="w-full group-hover:scale-105" src="https://api.spicezgold.com/download/file_1734525239704_foot.png" />
                                            </a>
                                        </div>
                                    </div>
                                </TableCell>
